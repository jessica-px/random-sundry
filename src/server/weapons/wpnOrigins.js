...
const sentences = [
    `Rumors say it was once a gift for a $HERO_ADJ $HERO.`,
    ...
    `They say a $HERO_ADJ $HERO performed great deeds with this weapon.`,
    `They say a $VILLAIN_ADJ $VILLAIN desperately tried to destroy this weapon.`,
    'They say a $VILLAIN_ADJ $VILLAIN once slew a $HERO_ADJ $HERO with this weapon.',
    'They say a $HERO_ADJ $HERO once slew a $VILLAIN_ADJ $VILLAIN  with this weapon.',
